            ...
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    response.dataset.map(function (row) {
                        ...
                        url = `productos.php?id=${row.id_marca}&nombre=${row.nombre_marca}`;
                        // Se crean y concatenan las tarjetas con los datos de cada categoría.
                        content += `
                            <div class="col s12 m6 l4">
                                <div class="card hoverable">
                                    <div class="card-image waves-effect waves-block waves-light">
                                        <img class="activator" src="../../resources/img/marca/${row.imagen_marca}">
                                    </div>
                                    <div class="card-content">
                                        ...
                                        <p class="center">
                                            <a href="${url}" class="tooltipped" data-tooltip="Ver más">
                                                <i class="material-icons small">assignment_returned</i>
                                            </a>
                                        </p>
                                    </div>
                    ...
                    document.getElementById('marquita').innerHTML = content;
