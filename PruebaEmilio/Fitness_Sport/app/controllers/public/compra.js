...
const API_COMPRA = '../../app/api/public/compra.php?action=';
...
function openCreateDialog() {
    ...
    document.getElementById('modal-title').textContent = 'Crear Consulta';
}
...
document.getElementById('save-form').addEventListener('submit', function (event) {
    ...
    saveRow(API_COMPRA, action, 'save-form', 'save-modal');
});
