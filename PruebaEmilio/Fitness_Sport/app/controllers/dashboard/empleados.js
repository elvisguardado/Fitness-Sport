...
const API_ADMIN_EMPL = '../../app/api/dashboard/administrar_empleados.php?action=';


// Método manejador de eventos que se ejecuta cuando el documento ha cargado.
document.addEventListener('DOMContentLoaded', function () {
    // Se llama a la función que obtiene los registros para llenar la tabla. Se encuentra en el archivo components.js
    readRows(API_ADMIN_EMPL);
});
...
document.getElementById('search-form').addEventListener('submit', function (event) {
    ...
    searchRows(API_ADMIN_EMPL, 'search-form');
});
        ...
        if (request.ok) {
            request.json().then(function (response) {
                ...
                if (response.status) {
                    ...
                    document.getElementById('nombre_admin_empl').value = response.dataset.nombres_usuario;
                    document.getElementById('apellido_admin_empl').value = response.dataset.apellidos_usuario;
                    document.getElementById('correo_admin_empl').value = response.dataset.correo_usuario;
                    document.getElementById('usuario_admin_empl').value = response.dataset.alias_usuario;
...
document.getElementById('save-form').addEventListener('submit', function (event) {
    ...
    saveRow(API_ADMIN_EMPL, action, 'save-form', 'save-modal');
});
...
function openDeleteDialog(id) {
    ...
    confirmDelete(API_ADMIN_EMPL, data);
}